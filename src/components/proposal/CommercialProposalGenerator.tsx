  ...
  return (
    <div className="min-h-screen bg-slate-100 py-6 px-4 sm:px-6 lg:px-8 text-slate-900 selection:bg-blue-600 selection:text-white print:bg-white print:p-0 print:m-0 print:min-h-0">
      ...
      {/* 
        ...
        Balanced Whitespace • Clean Typography • Real Contract Signature Block.
        ==================================================================
      */}
      <div 
        id="official-proposal-sheet"
        className="mx-auto bg-white text-slate-900 shadow-2xl rounded-xl border border-slate-200 p-8 text-xs leading-normal print:shadow-none print:border-none print:w-full print:p-0 print:m-0 space-y-4"
        style={{ 
          width: '794px', 
      ...
      >
        ...
        {/* 
          ...
          Clean Professional Commercial Agreement Format (Zero "X ______" markers).
        */}
        <div className="pt-3.5 border-t-2 border-slate-900 text-xs" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
          ...
          <div className="mt-3.5 pt-2 text-center text-[10px] text-slate-400">
